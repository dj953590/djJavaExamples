 ...
 */
public class djOptimizeLatency {
	...
	String fpath = f.getAbsolutePath();
        ...
        //You can keep on increasing the number of threads and see how th much time it takes to recolor the image in the 
        // resource folder to the out folder
